        ...
        <div className="w-full h-full flex items-start justify-center bg-transparent">
          <div className="text-center p-4 bg-white/60 rounded-lg">
            ...
            <div className="text-xs text-gray-500">
              Try re-publishing the Spline scene or check console/network.
            </div>
          </div>
        </div>
      )
  ...
  if (!isValid) {
    return (
      <div
        className={
          className +
          ' bg-gradient-to-br from-orange-100/30 to-transparent flex items-center justify-center rounded-2xl overflow-hidden'
        }
        style={style}
      >
        <div className="text-sm text-gray-500">
          3D model will appear here when scene is available
        </div>
      </div>
    )
  }
...
const LandingPage = () => {
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50 overflow-hidden"
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Link to="/dashboard">Explore Recipes Now</Link>
            </motion.button>
          </motion.div>
        </div>
      </section>
